...
{
    /// <inheritdoc />
    public partial class AddIdentityAndAdminRequests : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AdminRequestId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdminApprovals_AdminRequests_AdminRequestId",
                        column: x => x.AdminRequestId,
                        principalTable: "AdminRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdminApprovals_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminApprovals_AdminId",
                table: "AdminApprovals",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_AdminApprovals_AdminRequestId",
                table: "AdminApprovals",
